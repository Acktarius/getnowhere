...
- [ ] 2.2 Reorder `BottomNav`: Chats → Contacts → Wallet → Settings → Exit.
...
- [ ] 3.1 Add tests for: flush messages into wallet `chatRooms`; hydrate on
...
- [ ] 3.2 Implement transcript persist/hydrate in transport + wallet raw field;
  wire Exit flush; wire revoke/`leaveRoom` tombstone and keep
  `gnh.revokedRooms` consistent. Make 3.1 pass.
- [ ] 3.3 Update docs (`encryption.md` and/or `p2pchatprotocol.md`,
