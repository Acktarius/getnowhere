# topic-derivation-v2 (delta)

Capability: HKDF epoch-scoped Hyperswarm discovery topics with v1 coexistence.
...
- THEN it finds v1 as the only shipped codegen formula until v2 tasks complete
- AND it is directed to capabilities doc for v2 targets
